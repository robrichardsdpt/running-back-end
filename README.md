...
This template contains a project, `running_back_end`, and an app, `api`,
...
1. Replace all instances of `running_back_end` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `running_back_end` which should be renamed
...
all instances of `running_back_end` with your app's name.
